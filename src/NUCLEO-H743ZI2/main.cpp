...
using in_i2s = i2s_t<2, master_receiver, PB10, PB14, PB12, PC6>;
using out_i2s = i2s_t<3, master_transmitter, PB3, PB5, PA4, PC7>;
using dma = dma_t<1>;
...
int main()
{
    ...
    for (;;)
    {
        float x0 = 1.; // (1. / 4096.) * adc::read<a0>();
        float x1 = 1.; // (1. / 4096.) * adc::read<a1>();
